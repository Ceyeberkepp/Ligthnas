...
${selectedType==='vztmpl'? `<div class="head-actions"><button class="primary" type="button" data-template-browse data-template-storage="${sEsc(pool.id)}">Templates</button><span class="muted">Browse the same upstream appliance catalogs used by Proxmox pveam.</span></div>` : ''}
